...
import java.util.*;
	...
	public class ass6_aux {
	    ...
	    public static void main(String[] args) {
	        ...
	        TreeMap1.put(10L,new contact(987654321,"Ayush", contact.gender.male));
	        TreeMap1.put(20L,new contact(987637342,"Nitesh", contact.gender.female));
